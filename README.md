...
- 📤 **Экспорт в JSON и HTML** - возможность экспорта данных в форматах JSON и HTML для интеграции с другими системами
...
# Получить последние QA комментарии для нескольких тикетов
